...
from utils import generate_questions, add_sample_for_cross_encoder, get_samples_from_minio
import ast
...
channel = grpc.insecure_channel(f'{VECTOR_DB_INTERFACE_HOST}:{VECTOR_DB_INTERFACE_PORT}')
...
def add_to_vector_database(question, answer, autogenerated_questions, category):
    try:
        ...
        for q in all_questions:
            ...
            articles.append(vector_db_pb2.Article(
                content=q_a,
                categories=[category],
            ))
...
def save_df(gr_df):
    try:
        ...
        message = stub.UpdateArticles(vector_db_pb2.UpdateArticlesRequest(articles=articles))
...
with gr.Blocks() as demo:
    ...
    with gr.Tab("Cross Encoder"):
        ...
        btn_train_cross_encoder.click(
            train_cross_encoder_with_popup,
            model_name,
            show_progress=True
        )
