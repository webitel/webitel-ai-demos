...
class ChatServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Answer = channel.unary_unary(
                '/chatbot.ChatService/Answer',
                request_serializer=chatbot__pb2.MessageRequest.SerializeToString,
                response_deserializer=chatbot__pb2.MessageResponse.FromString,
...
def add_ChatServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Answer': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=chatbot__pb2.MessageResponse.SerializeToString,
            ),
    }
...
class ChatService(object):
    ...
    def Answer(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            chatbot__pb2.MessageResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
