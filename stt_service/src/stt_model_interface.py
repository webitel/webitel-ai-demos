...
def get_stt_model(model_type, model_paths, device):
...
class STT:
    def __init__(self, model_type, model_paths, device="cpu"):
        self.model_type = model_type
        self.model_path = model_paths
        self.stt_model = get_stt_model(model_type, model_paths, device)
